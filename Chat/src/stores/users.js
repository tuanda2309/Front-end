...
// --- THAY ĐỔI: Khai báo Link Server Render ---
const API_URL = 'https://back-end-teui.onrender.com';
...
export const useUserStore = defineStore('users', () =>
{
    ...
    const handleLogin = async (credentials) =>
    {
        ...
        await axios.post(`${API_URL}/auth/login`, formData)
            .then(async (response) =>
            {
                ...
                // --- THAY ĐỔI: Dùng API_URL ---
                const userInfo = await axios.get(`${API_URL}/auth/get_current_user`);
    ...
    const getUser = async () =>
    {
        ...
        if (tokenJWT)
        {
            ...
            // --- THAY ĐỔI: Dùng API_URL ---
            const userInfo = await axios.get(`${API_URL}/auth/get_current_user`).catch(async (e) =>
            {
                message.error(
